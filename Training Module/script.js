  ...
  switch (String(section.id)) {
    ...
    case '8':
      contentHtml += `
        ...
        <p>Approach AI as a powerful but flawed <span class="key-term">assistant</span>. Leverage its speed and pattern-finding abilities, but always apply your <span class="key-term">professional judgment</span>, <span class="key-term">critical thinking</span>, and <span class="key-term">ethical compass</span>. You remain the expert on your students and your classroom context.</p>
    ...
    case '10':
      contentHtml += `
        ...
        <ul class="list-disc list-inside ml-4 space-y-2 text-gray-700">
          <li>Aim for <span class="key-term">augmentation</span>, not automation</li>
